"""
TythanAI — CycloneDX VEX Exporter v1.0
...
class VEXExporter:
    """
    Converts TythanAI findings to a CycloneDX 1.4 VEX document.
    ...
    def _make_vulnerability(
        ...
        # Source: NVD for CVEs, otherwise TythanAI
        if cve_id:
            source = {
                "name": "NVD",
