"""
TythanAI Platform v13 — OpenTelemetry Setup
...
def setup_telemetry(
    ...
    the TythanAI built-in ``TraceContext`` tracer.
    ...
    try:
        ...
        logger.info(
            "opentelemetry not installed; using TythanAI TraceContext fallback "
            "(service=%s)",
            service_name,
        )
...
def get_tracer(name: str):
    ...
    this returns an OTel tracer.  Otherwise it returns the TythanAI
