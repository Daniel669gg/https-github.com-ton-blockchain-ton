...
class DependencyFixer:
    ...
    def create_pr(
        ...
        body = (
            ...
            "TythanAI Platform detected vulnerable dependencies and generated "
            "this automated fix PR.\n\n"
            "### Changes\n\n" + "\n".join(fix_lines) + "\n\n"
            "### Severity\n"
            f"Highest: **{fixes[0].severity if fixes else 'N/A'}**\n\n"
            "_Generated by TythanAI Platform — automated dependency fix_"
        )
        ...
        return {
            ...
            "note": (
                ...
                "TythanAI does not push to remote directly — "
