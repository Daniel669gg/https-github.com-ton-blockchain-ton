"""
TythanAI Platform — Compliance Report Generator
...
class ComplianceReport:
    ...
    def to_markdown(self) -> str:
        ...
        lines += [
            "---",
            "*Generated by TythanAI Platform — automated compliance evidence*",
...
class ComplianceReportGenerator:
    ...
    def generate(
        ...
        summary = (
            f"TythanAI Platform identified **{len(findings)} finding(s)** in the target codebase "
