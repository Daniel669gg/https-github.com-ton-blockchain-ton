"""
TythanAI — SARIF 2.1.0 Exporter
=======================================
Converts TythanAI findings (list of dicts) to valid SARIF JSON consumable
...
class SARIFExporter:
    """Convert TythanAI findings to SARIF 2.1.0 format.

    Parameters
    ----------
    tool_name:
        Override the ``tool.driver.name`` field (default: "TythanAI").
    tool_version:
...
def ghost_findings_to_sarif(
    ...
    tool_name:
        Displayed in ``tool.driver.name``; defaults to "TythanAI".
