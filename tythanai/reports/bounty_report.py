"""
TythanAI Platform — Bug Bounty Report Generator
...
class BugBountyReport:
    ...
    def immunefi_markdown(self) -> str:
        ...
        lines += [
            "---",
            "",
            "*Report generated by TythanAI Platform — defensive static analysis tool*",
...
class BugBountyReportGenerator:
    ...
    def executive_summary(
        ...
        lines = [
            ...
            f"**Audited by:** TythanAI Platform (static analysis)",
            "",
            "## Finding Overview",
            "",
        ...
        lines += [
            ...
            "",
            "---",
            "*Generated by TythanAI Platform — static analysis only, no funds were accessed*",
        ]
        return "\n".join(lines)
