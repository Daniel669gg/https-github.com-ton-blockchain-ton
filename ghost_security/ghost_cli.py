...
def cmd_server(args):
    ...
    print(f"\n🌐 Starting Ghost Security API Server")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Ghost Security Platform — Autonomous AI Security Auditor",
