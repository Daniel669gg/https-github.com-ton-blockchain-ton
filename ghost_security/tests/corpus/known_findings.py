"""
Ghost Security — Known-Findings Benchmark Corpus
=================================================
...
class CorpusValidator:
    """
    Run corpus entries through the appropriate Ghost Security scanner and
    ...
    def report(self, results: Dict[str, Any]) -> str:
        ...
        lines = [
            "=" * 68,
            "Ghost Security — Corpus Validation Report",
            "=" * 68,
