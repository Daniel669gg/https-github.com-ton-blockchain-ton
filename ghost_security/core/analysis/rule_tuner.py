"""
Ghost Security — Per-Rule Confidence Tuner
==========================================
...
class RuleTuner:
    ...
    def apply(self, findings: List[Dict]) -> List[Dict]:
        ...
        * ``tuning_note`` — populated with the reason when a tuning was applied.
        ...
        ----------
        findings:
            Raw findings as returned by any Ghost Security scanner.
...
_EXAMPLE_CONFIG = """\
# Ghost Security — Rule Tuning Configuration
# ===========================================
