...
Similar in spirit to OPA/Rego but purpose-built for Ghost Security findings,
...
class PolicyEngine:
    ...
    def generate_gate_report(self, result: PolicyResult) -> str:
        ...
        lines: List[str] = [
            "=" * 72,
            f"  SentinelOps Security Gate Report",
