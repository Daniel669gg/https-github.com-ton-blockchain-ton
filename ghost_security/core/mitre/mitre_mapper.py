"""
Ghost Security Platform — MITRE ATT&CK Mapper
...
# Covers Ghost Security internal rule namespaces
# ══════════════════════════════════════════════════════════════════════════════
...
class MITREMapper:
    """
    Enriches Ghost Security findings with MITRE ATT&CK context.
    ...
    def map_rule(self, rule_id: str) -> dict:
        """
        Resolve a Ghost Security rule_id to a MITRE ATT&CK technique dict.
