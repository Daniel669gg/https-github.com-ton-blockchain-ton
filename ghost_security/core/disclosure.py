"""
Ghost Security Platform — Responsible Disclosure Workflow
...
class DisclosureTracker:
    ...
    def generate_submission(self, did: str) -> str:
        ...
        lines = [
            ...
            f"**Target:** {rec.target}  ",
            f"**Date:** {date}  ",
            f"**Reporter:** {rec.reporter_name or 'Ghost Security'}",
            "",
            "## Summary",
            "",
        ...
        lines += [
            ...
            "## Timeline",
            "",
            f"- {date}: Vulnerability discovered via Ghost Security static analysis",
            ...
            "",
            "---",
            "*Discovered and reported by Ghost Security Platform*",
        ]
        return "\n".join(lines)
